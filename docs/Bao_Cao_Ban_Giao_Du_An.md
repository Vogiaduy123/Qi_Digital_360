...
*   **Google `<model-viewer>` (v3.4.0):** Thư viện hiển thị vật thể 3D trực quan trên nền tàm web, hỗ trợ các định dạng tiêu chuẩn như `.glb` / `.gltf` kèm khả năng xoay, zoom và xem dưới dạng AR.
